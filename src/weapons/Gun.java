...
public class Gun extends Weapon{
	...
	public void use(Point2D.Double pos){
		...
		Projectile bullet = new Projectile(damage, new Circle(size, new Point2D.Double(player.pos.x, player.pos.y)), new Point2D.Double((pos.x-player.pos.x),(pos.y-player.pos.y)), immunity, player, true, 8.0, true, Color.ORANGE, null, 0, true, true);
